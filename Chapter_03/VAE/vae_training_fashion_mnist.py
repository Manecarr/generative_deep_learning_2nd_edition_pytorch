...
EXPERIMENT_NAME = "Chapter_03/VAE_fashion_mnist"

setup_mlflow(experiment_name=EXPERIMENT_NAME)


vae_data_transforms = Compose([ToTensor(), Pad((2,))])

download_datasets = partial(
    get_fashion_mnist_dataset, split="both", save_path=DATA_CACHE_DIR, transform=vae_data_transforms, download=True
)
